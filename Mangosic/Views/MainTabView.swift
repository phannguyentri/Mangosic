...
struct MainTabView: View {
    ...
    var body: some View {
        ZStack(alignment: .bottom) {
            ...
            // Now Playing Bar (floating above tab bar when track is playing)
            // Hide when full player is showing
            if playerViewModel.currentTrack != nil && !playerViewModel.showingPlayer {
                VStack(spacing: 0) {
                    Spacer()
...
/// Home view (replaces the original ContentView layout)
        ...
        NavigationStack {
            ZStack(alignment: .bottom) {
                ...
                ScrollView {
                    ...
                    .padding()
                    .padding(.bottom, viewModel.currentTrack != nil ? 120 : 20)
                }
